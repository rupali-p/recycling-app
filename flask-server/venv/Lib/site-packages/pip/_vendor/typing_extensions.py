...
_EXCLUDED_ATTRS = {
    ...
    "__subclasshook__", "__orig_class__", "__init__.py", "__new__",
    ...
    class TypeVarTuple(_DefaultMixin):
        ...
        signatures and variable annotations::
            ...
            class Array(Generic[*Ts]):
                ...
                def __init__.py(self, shape: Tuple[*Ts]):
...
if sys.version_info >= (3, 12):
    ...
    def dataclass_transform(
        ...
        **kwargs: typing.Any,
        ...
        decorator. For example, the type checker will synthesize an ``__init__.py``
        method.
